...
#find the best models by outputting the ones with the lowest AIC
...
## 3.2 Minimal Package
``` {r 3.2}
# create the rashomonlite package
dir.create("rashomonlite")
dir.create("rashomonlite/R")
file.create("rashomonlite/DESCRIPTION")
file.create("rashomonlite/NAMESPACE")
system("R CMD build rashomonlite")
install.packages("rashomonlite_0.1.0.tar.gz", repos = NULL, type = "source")
...
for (k in 1:3) {
  cat("\n=== Dimension", k, "===\n")
  print(out$M[[k]][order(out$M[[k]]$aic), ][1:5, c("variables","aic")])
}
